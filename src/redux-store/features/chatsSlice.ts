...
const chatsSlice = createSlice({
  ...
  reducers: {
    ...
    addMessageId(
      ...
      if (state.currentChatId === action.payload.chatId && chat) {
        chat.messageIds.push(action.payload.messageId);
      }
    },
  ...
  selectors: {
    ...
    selectChatPartnerIdByChatId: (chatsState, chatId: string) => {
