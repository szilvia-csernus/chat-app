...
export default async function Home() {
  ...
  return (
    <div className="h-full min-h-[calc(100dvh-80px)] w-full flex flex-col justify-stretch items-center">
      <div
        className="flex-grow items-center w-full h-[calc(100dvh-160px)] md:h-[calc(100dvh-176px)] md:my-2 py-8 px-5 text-center text-slate-600
       dark:text-slate-300 md:border-1 border-slate-300 dark:border-slate-800 bg-zig-zag flex 
       flex-col gap-7"
      >
